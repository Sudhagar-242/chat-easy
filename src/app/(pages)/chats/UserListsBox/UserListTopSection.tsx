...
//             <div className={`w-full h-8.5  not-active-search-parent group`}>
//               <InputText
//                 placeholder="Search"
//                 className="not-active-search-input"
//                 disabled={true}
//                 pt={{
//                   root: {
//                     className:
...
//                 }}
//               />
//               <InputIcon className="pi pi-search not-active-search-icon ">
//                 {" "}
//               </InputIcon>
//             </div>
//           </div>
//         )}
//         {onClick && (
//           <div className={`w-full h-8.5 active-search-parent`}>
//             {haveFilter && (
...
//                 root: {
//                   className:
//                     "!focus:ring-0 !border-none flex-1 max-w-35 min-w-20 !shadow-none !outline-none !ring-0 !h-full",
//                 },
//               }}
//               autoFocus
//             />
...
//             <i
//               className="pi pi-times active-search-icon"
